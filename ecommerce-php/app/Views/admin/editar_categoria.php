  ...
  <div class="flex min-h-screen">
    ...
    <div class="flex-1 p-4 md:p-10 space-y-6 min-w-0">
      ...
      <div class="flex items-center gap-2 text-sm text-gray-400">
        ...
        <span class="text-gray-700 font-semibold">Editar Categoria</span>
      </div>
      ...
      <div class="glass-card rounded-3xl shadow-sm overflow-hidden max-w-xl">
        ...
        <div class="px-8 py-6 border-b border-gray-100 flex items-center gap-4">
          ...
          <div class="flex items-center gap-3 flex-1">
            <div class="h-10 w-10 rounded-xl flex items-center justify-center bg-pink-50 flex-shrink-0">
              <i class="fas fa-tag text-pink-400"></i>
            </div>
            <div>
              <h2 class="text-xl font-extrabold text-gray-900 tracking-tight">
                <?php echo htmlspecialchars((string) ($categoria['nome'] ?? 'Editar Categoria'), ENT_QUOTES, 'UTF-8'); ?>
              </h2>
              <p class="text-gray-400 text-xs font-medium mt-0.5">Editando categoria #<?php echo (int) $categoria_id; ?>
              </p>
            </div>
          </div>
        </div>
        ...
        <!-- Formulário -->
        <form
          action="<?php echo htmlspecialchars(url('admin/categorias/editar') . '?id=' . (int) $categoria_id, ENT_QUOTES, 'UTF-8'); ?>"
          ...
          <div class="space-y-1.5">
            ...
            <input type="text" name="nome" id="nome" required placeholder="Ex: Convites, Lembranças, Decoração..."
              value="<?php echo htmlspecialchars((string) ($categoria['nome'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>"
          ...
          <div class="space-y-1.5">
            ...
            <textarea name="descricao" id="descricao" rows="3" placeholder="Descreva brevemente esta categoria..."
              class="form-input w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm bg-white resize-none"><?php echo htmlspecialchars((string) ($categoria['descricao'] ?? ''), ENT_QUOTES, 'UTF-8'); ?