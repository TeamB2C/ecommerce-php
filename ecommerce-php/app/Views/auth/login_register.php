    ...
    <div class="container" id="container">
        ...
        <div class="form-box login">
            ...
            <form method="POST" action="<?php echo url('login'); ?>">
                ...
                <?php if ($erroLogin): ?>
                    <p class="erro">
                        <?php echo htmlspecialchars($erroLogin, ENT_QUOTES, 'UTF-8'); ?>
                    </p>
                <?php endif; ?>
...
<button
    ...
    onclick="window.location.href='<?php echo url('google-login'); ?>'">
    ...
    Entrar com Google
        ...
        <div class="form-box registro">
            ...
            <?php if (!empty($erroRegistro)): ?>
                <p style="color:red;">
                    <?php echo htmlspecialchars($erroRegistro, ENT_QUOTES, 'UTF-8'); ?>
                </p>
            <?php endif; ?>
